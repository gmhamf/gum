...
@section('title-ar', 'تسجيل دخول المدرب')
...
<div class="auth-container">
    <div class="auth-card">
        ...
        <h1 class="auth-title" data-en="Trainer" data-ar="المدرب">Trainer</h1>
        <p class="auth-subtitle" data-en="Check your schedule and clients" data-ar="تابع جدولك ومشتركيك">
            Check your schedule and clients
        </p>
